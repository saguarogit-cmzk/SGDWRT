...
| D-004 | `/opt/saguaro` na **zasebnoj ext4 particiji** | Preživljava `sysupgrade` (nadogradnju firmwarea). Na 200 GB diska prostora ima napretek. Mount preko UCI `fstab` (block-mount). | Prihvaćeno |
